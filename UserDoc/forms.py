...
import datetime
from UserDoc.models import Salarie
...
class UtilisateurForm(forms.ModelForm):
    ...
    non_required_fields = [
            ...
            'cnss', 'certification', 'departement', 'poste', 'contrat', 'dateEmbauche', 'salaireBase'
            ]
    ...
    class Meta:
        ...
        fields = [
            ...
            'contrat', 'dateEmbauche', 'salaireBase'
        ]
    ...
    photo = forms.ImageField(widget=forms.ClearableFileInput(attrs={'onchange': 'previewImage(event)'}))
